...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--news_encoder', type=str, default='CNRCL', choices=['CNRCL', 'CNN', 'MHSA', 'KCNN', 'HDC', 'NAML', 'PNE', 'DAE', 'Inception'], help='News encoder')
        parser.add_argument('--user_encoder', type=str, default='CNRCL', choices=['CNRCL', 'LSTUR', 'MHSA', 'ATT', 'CATT', 'FIM', 'PUE', 'GRU', 'OMAP'], help='User encoder')
        ...
        parser.add_argument('--max_title_length', type=int, default=24, help='Sentence truncate length for title')
        parser.add_argument('--max_abstract_length', type=int, default=48, help='Sentence truncate length for abstract')
        # Training config
        ...
        parser.add_argument('--similarity_num', type=int, default=3, help='Number of similarity news for candidate news')
        parser.add_argument('--retain', type=float, default=0.4, help='first stage retain ratio for unclicked news')
